...
async function loadEmoji(quark) {
    ...
    emojis.forEach(function(emoji) {
        document.querySelector("#watchedmojos").innerHTML += `<img src="${emoji.imageUri}" loading="lazy"alt="${emoji.altText}" title="${emoji.description || emoji.altText}" onclick="insertEmoji('${emoji.name}', '${emoji._id}')">`;
    })
